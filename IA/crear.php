...
$nodo 		     = $_POST['nodo'];
$nombre 		 = $_POST['nombre'];
$imagenn = addslashes(file_get_contents($_FILES['img']['tmp_name']));//GUARDAMOS TODA LA IMAGEN
...
$consulta = "INSERT INTO arbol (nodo,texto,pregunta,imagen) VALUES('$NumHijoI','$nombre',FALSE,'$imagenn');";
